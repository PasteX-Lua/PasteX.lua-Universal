...
local SilentAimSettings = {
    ...
    ClassName = "PasteX.lua  |  discord : extrt.692",
    ToggleKey = "U",
...
local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/PasteX-Lua/PasteX.lua-Universal/refs/heads/main/mobileLib.lua"))()
