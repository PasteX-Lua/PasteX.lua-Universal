...
if UIS.TouchEnabled and not UIS.MouseEnabled and not UIS.KeyboardEnabled then
    ...
    loadstring(game:HttpGet('https://raw.githubusercontent.com/PasteX-Lua/PasteX.lua-Universal/refs/heads/main/PasteXMobile.lua'))() return
end
...
local SilentAimSettings = {
    ...
    ClassName = "PasteX.lua  |  discord : extrt.69",
    ToggleKey = "U",
...
local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/PasteX-Lua/PasteX.lua-Universal/refs/heads/main/linoralib.lua"))()
local ThemeManager = loadstring(game:HttpGet("https://raw.githubusercontent.com/PasteX-Lua/PasteX.lua-Universal/refs/heads/main/manage2.lua"))()
local SaveManager = loadstring(game:HttpGet("https://raw.githubusercontent.com/PasteX-Lua/PasteX.lua-Universal/refs/heads/main/manager.lua"))()

Library.KeybindFrame.Visible = true;

local Window = Library:CreateWindow({
    Title = 'PasteX.lua  |  discord : extrt.692',
    Center = true,
    AutoShow = true,  
    TabPadding = 8,
    MenuFadeTime = 0.2
...
if not _G.ExunysESPLoaded then
    loadstring(game:HttpGet("https://raw.githubusercontent.com/PasteX-Lua/PasteX.lua-Universal/refs/heads/main/ESP.lua"))()
end
